...
import { ArrayOfObjectCapability, CapabilityPayload, CapabilityPayloadSmallName, SuccsessCreateCapability, SuccsessGetCapabilityById, SuccsessUpdateCapability } from './mocks/capability-payload.mocks';
...
describe('CapabilityService', () => {
  ...
  it('should create a capability', async () => {
    expect(await service.create(CapabilityPayload)).toEqual(SuccsessCreateCapability);
  });
  ...
  it('should get a capability', async () => {
    expect(await service.findById(MockId)).toEqual(SuccsessGetCapabilityById(StringMockId));
  });

  it('should get list of capabilitys', async () => {
    expect(await service.find({ name:'CREATE' })).toEqual(ArrayOfObjectCapability);
  });

  it('should delete a capability', async () => {
    expect(await service.delete(MockId)).toEqual(SuccsessGetCapabilityById(StringMockId));
  });
