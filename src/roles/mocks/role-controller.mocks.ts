import { ArrayOfObjectRole, SuccsessCreateRole, SuccsessCreateRoleNoFeature } from "./role-payload.mocks"
...
export const RoleControllerMock = {
    ...
    find: jest.fn().mockImplementation(() => { return ArrayOfObjectRole }),
    findByIdAndUpdate: jest.fn().mockImplementation((id, dto) => { return { id: id.id, ...dto } }),
    findByIdAndDelete: jest.fn().mockImplementation((id) => { return { id: id.id, ...SuccsessCreateRole } })
}