...
import { ArrayOfObjectNavigation, MockId, NavigationPayload, SuccsessCreateNavigation, SuccsessGetNavigationById, SuccsessUpdateNavigation } from './mocks/navigation-payload.mocks';
...
describe('NavigationController', () => {
  ...
  it(`should create a navigation (Controller)`, async () => {
    expect(await controller.create(NavigationPayload)).toEqual(SuccsessCreateNavigation)
  })

  it(`should update a navigation (Controller)`, async () => {
    expect(await controller.update(MockId, NavigationPayload)).toEqual(SuccsessUpdateNavigation(MockId.id))
  })

  it(`should get a navigation (Controller)`, async () => {
    expect(await controller.findById(MockId)).toEqual(SuccsessGetNavigationById(MockId.id))
  })
  ...
  it(`should delete a navigation (Controller)`, async () => {
    expect(await controller.delete(MockId)).toEqual(SuccsessGetNavigationById(MockId.id))
  })
