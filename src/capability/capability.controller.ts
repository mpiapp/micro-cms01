...
export class CapabilityController {
    ...
    @ApiCreatedResponse({ type: Capabilities, description: 'update a navigation' })
    @ApiBadRequestResponse({ description: 'False Request Payload' })
    @ApiParam({ name: 'id', required: true })
    @Put(':id')
    async update(@Param('id') id: IdDTO, @Body() body: UpdateCapabilitiesDTO): Promise<Capabilities> {
    ...
    @ApiOkResponse({ type: Capabilities, description: 'delete a navigation by ID' })
    @ApiBadRequestResponse({ description: 'False Request Payload' })
    @Delete(':id')
